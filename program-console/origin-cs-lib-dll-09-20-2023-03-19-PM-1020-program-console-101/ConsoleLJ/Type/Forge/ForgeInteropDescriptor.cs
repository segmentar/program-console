    ...
    public partial class ConsoleLJ
    {
        public static String ForgeInteropDescriptor()
        {
            ...
            var descriptor = new String[] {
                ...
                String.Empty,
                String.Empty + '\t' + '\t' + nameof(ArchitectureZeroTen.HasValidInputDirectory) + ':' + ' ' + ArchitectureZeroTen.HasValidInputDirectory,
                String.Empty,
                ...
                String.Empty,
                String.Empty + '\t' + '\t' + nameof(ArchitectureZeroTen.HasValidOutputDirectory) + ':' + ' ' + ArchitectureZeroTen.HasValidOutputDirectory,
                String.Empty,
